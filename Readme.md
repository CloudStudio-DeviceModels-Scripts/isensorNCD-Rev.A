...
# Parsing + Configuration Script – isensorNCD - Rev. A

This **Parsing + Configuration** script is designed for the **isensorNCD** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – isensorNCD Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **isensorNCD** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
